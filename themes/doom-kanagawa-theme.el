;;; doom-kanagawa-theme.el --- inspired by morhetz's Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; color swap from doom-gruvbox:
...
(defcustom doom-kanagawa-dark-variant nil
...
(def-doom-theme doom-kanagawa
  ...
  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-kanagawa-dark-variant "hard") '("#181820" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-kanagawa-dark-variant "soft") '("#2A2A37" "#323232" nil))   ; bg0_s
          (t                                        '("#1F1F28" "#1F1F28" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-kanagawa-dark-variant "hard") '("#252535" "black" nil))     ; (self-defined)
          ((equal doom-kanagawa-dark-variant "soft") '("#1F1F28" "#1F1F28" nil))   ; bg0
          (t                                        '("#181820" "#1e1e1e" nil)))) ; bg_h
   (bg-alt2    '("#504945" "#504945" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#16161D" "black"   "black"      )) ; (self-defined)
   (base1      '("#1F1F28" "#1d1d1d" "brightblack")) ; bg0_h
   (base2      '("#2A2A37" "#1F1F28" "brightblack")) ; bg0
   (base3      '("#252535" "#363646" "brightblack")) ; bg1
   (base4      '("#54546D" "#5c5c5c" "brightblack")) ; bg3
   ...
   (fg         '("#DCD7BA" "#dfdfdf" "brightwhite")) ; fg/fg1
   (fg-alt     '("#C8C093" "#cccccc" "brightwhite")) ; fg2

   ;; Standardized official colours from gruvbox
   (grey        '("#928374" "#909090" "brightblack"))   ; gray
   (red         '("#957FB8" "#e74c3c" "red"))           ; bright-red
   (magenta     '("#FF5D62" "#cc241d" "magenta"))       ; red
   (violet      '("#D27E99" "#E6C384" "brightmagenta")) ; bright-purple
   (orange      '("#FFA066" "#fd971f" "orange"))        ; bright-orange
   (yellow      '("#DCA561" "#FF9E3B" "yellow"))        ; bright-yellow
   (dark-yellow '("#FF9E3B" "#FF9E3B" "yellow"))        ; yellow
   (teal        '("#98BB6C" "#8ec07c" "green"))         ; bright-aqua
   (green       '("#7AA89F" "#7AA89F" "green"))         ; bright-green
   (dark-green  '("#76946A" "#98971a" "green"))         ; green
   (blue        '("#7FB4CA" "#83a598" "brightblue"))    ; bright-blue
   (dark-blue   '("#658594" "#458588" "blue"))          ; blue
   (cyan        '("#9CABCA" "#8ec07c" "brightcyan"))    ; bright-aqua
   (my-black    '("#16161D" "#16161D" "black"))         ; doom-bar
   (dark-cyan   '("#6A9589" "#689d6a" "cyan"))          ; aqua
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-kanagawa-brighter-comments magenta grey))
   (doc-comments   (if doom-kanagawa-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
